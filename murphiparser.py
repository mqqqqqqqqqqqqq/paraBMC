...
grammar = r"""
    ...
    ?add_expr: eq_expr "+" add_expr
        | eq_expr

    ?mod_expr: add_expr "%" mod_expr
        | add_expr
        | mod_expr "%" add_expr
        
    ?and_expr: mod_expr "&" and_expr
        | mod_expr
    ...
    ?smaller_expr: div_expr "<=" smaller_expr
        | div_expr
...
if __name__ == "__main__":
    ...
    parse_path = "protocols/consensus/"
    parse_name = "consensus"
